...
Configuration based on [catppuccin](https://catppuccin.com/palette/) **mocha** color palette, uses **lavender** as accent color.

## Usage

Follow the setup instructions inside each folder.
